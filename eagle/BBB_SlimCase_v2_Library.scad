...
BB_TEMP_Z = 10;
BB_TEMP1_Y = 27;
BB_TEMP2_Y = BB_TEMP1_Y + (2.54 * 3.0 );
BB_TEMP3_Y = BB_TEMP2_Y + (2.54 * 3.0);
...
BB_ADD_Z = 17.0;
AdditionalSDCard_Space = 2.0;

//CASE DIMENSIONS
//Outer Shell
Case_Thickness = 1.50;     //Wall Thickness
Case_Gap = 0.75;  //Gap between case walls and board
Case_L = AdditionalSDCard_Space + BB_L + Case_Thickness*2 + Case_Gap*2;
...
Case_Z = Case_Thickness + Case_PCB_Z + BB_Z + BB_P9_Z + BB_ADD_Z;      //Total height of case
Cmp_Gap = 0.25;      //Gap around components
Cmp_Gap2 = Cmp_Gap*2;   //Gap around components times two

//Shell hollow inside dimensions
CutOut_L = AdditionalSDCard_Space + BB_L + Case_Gap*2;
